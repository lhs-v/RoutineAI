...
| `app_pair` | 두 앱을 분할화면 세트로 | appPairs: 왕복≥10 이고 (**갈아타기 중앙≤10초** 또는 왕복 주기 중앙≤60초), 또는 coUseCount≥3 | 두 앱의 목적이 하나의 활동으로 이어진다. 갈아타기(떠나서 다음을 열기까지)가 몇 초면 홈은 통로일 뿐 — 한쪽을 오래 보는 페어(비교·검토형)도 갈아타기가 짧으면 한 흐름이다 |
